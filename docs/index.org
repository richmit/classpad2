...
:END:
 ...
 - *=slvLinEq=*: Solve matrix equation
 - *=slvLinODEq=*: Solve over determined matrix equation
...
:END:
 ...
 - *=newtonC=*: Solve complex equations with Newton's method.  This one pauses every 10 iterations to ask if you want it to keep searching.
 - *=newtonCC=*: Solve complex equations with Newton's method.  This one runs forever trying to find a root.

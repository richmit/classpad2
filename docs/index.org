...
# This one pauses every 10 iterations to ask if you want it to keep searching.
# - *=newtonCC=*: Solve complex equations with Newton's method.  This one runs forever tyring to find a root.
